...
namespace WinAppServiceBus
{
    public class TreeViewHelper : IComparer
    {
        ...
        public int Compare(object x, object y)
        {
            ...
            if (leftNode.ImageIndex == Form1.UrlSegmentIconIndex &&
                rightNode.ImageIndex == Form1.UrlSegmentIconIndex)
            {
            ...
            if (rightNode.ImageIndex == Form1.UrlSegmentIconIndex)
            {
                return 1;
            }
