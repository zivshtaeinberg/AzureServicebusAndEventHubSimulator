...
// ReSharper restore CheckNamespace
{
    ...
    public class ServiceBusHelper
    {
        ...
        private static Form1.EncodingType encodingType = Form1.EncodingType.ASCII;
        #endregion
        ...
        /// </summary>
        public static Form1.EncodingType EncodingType
        {
            get
            {
                return encodingType;
        ...
        public RelayDescription CreateRelay(RelayDescription description)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnCreate != null) OnCreate(new ServiceBusHelperEventArgs(relayService, Form1.EntityType.Relay));
                return relayService;
            }
            throw new ApplicationException(ServiceBusIsDisconnected);
        }
        ...
        public void DeleteRelay(string path)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(path, Form1.EntityType.Relay));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public EventHubDescription CreateEventHub(EventHubDescription description)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnCreate != null) OnCreate(new ServiceBusHelperEventArgs(eventHub, Form1.EntityType.EventHub));
                return eventHub;
            }
            throw new ApplicationException(ServiceBusIsDisconnected);
        }
        ...
        public void DeleteEventHub(string path)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(path, Form1.EntityType.EventHub));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public void DeleteEventHub(EventHubDescription eventHubDescription)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(eventHubDescription, Form1.EntityType.EventHub));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public ConsumerGroupDescription CreateConsumerGroup(ConsumerGroupDescription description)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnCreate != null) OnCreate(new ServiceBusHelperEventArgs(consumerGroup, Form1.EntityType.ConsumerGroup));
        ...
        public void DeleteConsumerGroup(string eventHubName, string name)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null)
                    OnDelete(new ServiceBusHelperEventArgs(new ConsumerGroupDescription(eventHubName, name), Form1.EntityType.ConsumerGroup));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public void DeleteConsumerGroup(ConsumerGroupDescription consumerGroupDescription)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null)
                    OnDelete(new ServiceBusHelperEventArgs(consumerGroupDescription, Form1.EntityType.ConsumerGroup));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public void DeleteNotificationHub(string path)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(path, Form1.EntityType.NotificationHub));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public NotificationHubDescription CreateNotificationHub(NotificationHubDescription description)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnCreate != null)
                    OnCreate(new ServiceBusHelperEventArgs(notificationHub, Form1.EntityType.NotificationHub));
        ...
        public void DeleteNotificationHub(NotificationHubDescription notificationHubDescription)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null)
                    OnDelete(new ServiceBusHelperEventArgs(notificationHubDescription, Form1.EntityType.NotificationHub));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public QueueDescription CreateQueue(string path)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnCreate != null) OnCreate(new ServiceBusHelperEventArgs(queue, Form1.EntityType.Queue));
                return queue;
            }
            throw new ApplicationException(ServiceBusIsDisconnected);
        }
        ...
        public void DeleteQueue(string path)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(path, Form1.EntityType.Queue));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public void DeleteQueue(QueueDescription queueDescription)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(queueDescription, Form1.EntityType.Queue));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public TopicDescription CreateTopic(string path)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnCreate != null) OnCreate(new ServiceBusHelperEventArgs(topic, Form1.EntityType.Topic));
                return topic;
            }
            throw new ApplicationException(ServiceBusIsDisconnected);
        }
        ...
        public void DeleteTopic(string path)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(path, Form1.EntityType.Topic));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public void DeleteTopic(TopicDescription topic)
        {
            ...
            if (namespaceManager != null)
            {
                ...
                if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(topic, Form1.EntityType.Topic));
            }
            else
            {
                throw new ApplicationException(ServiceBusIsDisconnected);
        ...
        public SubscriptionDescription CreateSubscription(TopicDescription topicDescription, SubscriptionDescription subscriptionDescription)
        {
            ...
            if (OnCreate != null)
                OnCreate(new ServiceBusHelperEventArgs(new SubscriptionWrapper(subscription, topicDescription), Form1.EntityType.Subscription));
            return subscription;
        }
        ...
        public void DeleteSubscription(string topicPath, string name)
        {
            ...
            if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(name, Form1.EntityType.Subscription));
        }
        ...
        public void DeleteSubscription(SubscriptionDescription subscriptionDescription)
        {
            ...
            if (OnDelete != null)
                OnDelete(new ServiceBusHelperEventArgs(subscriptionDescription, Form1.EntityType.Subscription));
        }
        ...
        public RuleDescription AddRule(SubscriptionDescription subscriptionDescription, RuleDescription ruleDescription)
        {
            ...
            if (OnCreate != null)
                OnCreate(new ServiceBusHelperEventArgs(new RuleWrapper(rule, subscriptionDescription), Form1.EntityType.Rule));
            return rule;
        }
        ...
        public void RemoveRule(SubscriptionDescription subscriptionDescription, string name)
        {
            ...
            if (OnDelete != null) OnDelete(new ServiceBusHelperEventArgs(name, Form1.EntityType.Rule));
        }
        ...
        public void RemoveRule(SubscriptionDescription subscriptionDescription, RuleDescription rule)
        {
            ...
            if (OnDelete != null)
                OnDelete(new ServiceBusHelperEventArgs(new RuleWrapper(rule, subscriptionDescription), Form1.EntityType.Rule));
        }
        ...
        private static Encoding GetEncoding()
        {
            switch (encodingType)
            {
                case Form1.EncodingType.ASCII: 
                    return Encoding.ASCII;
                case Form1.EncodingType.UTF7: 
                    return Encoding.UTF7;
                case Form1.EncodingType.UTF8: 
                    return Encoding.UTF8;
                case Form1.EncodingType.UTF32: 
                    return Encoding.UTF32;
                case Form1.EncodingType.Unicode: 
